...
## 3. Conclusion
해당 레포지토리에서는 Detectivity Method에 대한 가이드라인만을 제공하였기 때문에 기존 매트랩 방식의 결과와 비교하는 과정을 생략하였습니다. 다만 매트랩의 방식에 더하여 논문을 바탕으로 또 다른 방식의 RUL 예측 기법을 구현 및 제시하였으며, 이에 대한 튜토리올로써 참고될 수 있음을 말씀드립니다. 기존 방식과의 비교 결과는 보고서를 참고해주시면 감사하겠습니다.
