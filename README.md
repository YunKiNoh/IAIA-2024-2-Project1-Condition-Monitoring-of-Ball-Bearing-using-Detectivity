...
## 2. Process
매트랩에서 제공하는 기본적인 RUL 예측 기법은 진동 데이터 셋을 통해서 시간 영역 및 주파수 영역 파라미터를 추출하여 진동 특성을 잘 담아내는 파라미터를 선정 및 머신러닝 학습으로 정리될 수 있습니다. [Link: https://kr.mathworks.com/help/predmaint/ug/wind-turbine-high-speed-bearing-prognosis.html]. 해당 방식과 Detectivity 기법을 비교하기 위해서 저희는 풍력 발전 데이터셋을 다운로드하여 데이터 전처리 및 RUL 예측을 다음과 같이 진행하였습니다.
